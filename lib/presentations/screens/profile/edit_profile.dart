          ...
          child: Column(
            children: [
              ...
              Align(
                  ...
                  child: AutoSizeText('Profile Setting', style: TextStyle(fontSize: 24.sp, color: AppColors.kPrimaryColor))),
              25.verticalSpace,
              Center(
                child: ProfilePhoto(
                  cornerRadius: 50.r,
              ...
              20.verticalSpace,
              Align(alignment: Alignment.centerLeft, child: AutoSizeText('Name', style: TextStyle(fontSize: 14.sp, color: AppColors.kPrimaryColor))),
              4.verticalSpace,
              CustomTextFormField(
              ...
              10.verticalSpace,
              Align(alignment: Alignment.centerLeft, child: AutoSizeText('Email', style: TextStyle(fontSize: 14.sp, color: AppColors.kPrimaryColor))),
              4.verticalSpace,
              CustomTextFormField(
                 fillColor: AppColors.dark10.withOpacity(0.3),
                prefixIcon: const Icon(
              ...
              Align(
                  alignment: Alignment.centerLeft,
                  child: AutoSizeText('Phone Number', style: TextStyle(fontSize: 14.sp, color: AppColors.kPrimaryColor))),
              4.verticalSpace,
              CustomTextFormField(
                 fillColor: AppColors.dark10.withOpacity(0.3),
                prefixIcon: const Icon(
              ...
              OnProcessButtonWidget(
                ...
                child: AutoSizeText('Update', style: TextStyle(fontSize: 16.sp, color: Colors.white)),
              )
            ],
          ),
        ));
