...
import 'package:hotel_management/presentations/widgets/custom_animated_size_widget.dart';
...
class CustomTextFormField extends StatefulWidget {
  const CustomTextFormField({
    ...
    this.errorCheck,
    this.errorBuilder,
    this.enableBoderColor,
    this.focusBoderColor,
  });
...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
      ...
      return Text(
        ...
        style: widget.errorTextStyle ??
            Theme.of(context)
                .textTheme
                .bodySmall
                ?.copyWith(color: widget.errorColor ?? Theme.of(context).colorScheme.error, fontWeight: FontWeight.bold),
      );
    } else {
      return SizedBox();
    }
  ...
  Widget build(BuildContext context) {
    ...
    contentPadding = widget.contentPadding ?? EdgeInsets.symmetric(horizontal: 8.0.w, vertical: 4.0.h);
      ...
      children: [
        Focus(
          ...
          child: TextFormField(
            ...
            style: widget.style ??
                Theme.of(context).textTheme.titleMedium?.copyWith(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: !error
                  ? widget.hintStyle ?? TextStyle(color: Theme.of(context).colorScheme.primary.withOpacity(0.5))
                  : widget.errorStyle ??
                      widget.hintStyle?.copyWith(color: Theme.of(context).colorScheme.error) ??
                      TextStyle(color: Theme.of(context).colorScheme.error),
              errorStyle: const TextStyle(height: 0),
              contentPadding: contentPadding,
              // contentPadding: EdgeInsets.zero,
              enabledBorder:
                  widget.enabledBorder?.copyWith(borderSide: BorderSide(width: 2, color: widget.enableBoderColor ?? Theme.of(context).colorScheme.primary.withOpacity(0.5))) ??
                      OutlineInputBorder(
                        borderRadius: borderRadius,
                        borderSide: BorderSide(width: 2, color: Theme.of(context).colorScheme.background.withOpacity(0.5)),
                      ),
              focusedBorder: widget.focusedBorder?.copyWith(borderSide: BorderSide(width: 2, color: widget.focusBoderColor ?? Theme.of(context).colorScheme.primary)) ??
                  OutlineInputBorder(
                    borderRadius: borderRadius,
                    borderSide: BorderSide(width: 2, color: Theme.of(context).colorScheme.background),
                  ),
              ...
              focusedErrorBorder: widget.focusedErrorBorder
                      ?.copyWith(borderSide: BorderSide(width: 2, color: Theme.of(context).colorScheme.primary.withOpacity(0.5))) ??
                  OutlineInputBorder(
                    borderRadius: borderRadius,
                    borderSide: BorderSide(width: 2, color: Theme.of(context).colorScheme.primary.withOpacity(0.5)),
                  ),
              disabledBorder:
                  widget.disabledBorder?.copyWith(borderSide: BorderSide(width: 2, color: Theme.of(context).colorScheme.primary.withOpacity(0.1))) ??
                      OutlineInputBorder(
                        borderRadius: borderRadius,
